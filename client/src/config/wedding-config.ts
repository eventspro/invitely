...
export const weddingConfig = {
  ...
  hero: {
    ...
    welcomeMessage:
      "Հարգելի հյուրեր, սիրով հրավիրում ենք Ձեզ ներկա գտնվելու մեր հարսանյաց արարողությանը։ Ծանոթացեք ծրագրին և հաստատեք ձեր ներկայությունը մինչև Հոկտեմբերի 1-ը։",
